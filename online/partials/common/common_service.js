...
define(function () {
    ...
    commonService.factory('$_http', ['$rootScope', '$stateParams', '$http', '$q', function($rootScope, $stateParams, $http, $q){
        return {
    ...
    commonService.factory('$_socket', ['$rootScope', function ($rootScope) {
        var socket = io();
        return {
    ...
    commonService.factory('$_yaq', ['$rootScope', '$stateParams', '$filter', function ($rootScope, $stateParams, $filter) {
        //时间序列化
